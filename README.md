...
```
github "VirgilSecurity/virgil-e3kit-x" ~> 2.0.0
```
...
```swift 
    ...
    let ethree = try! EThree(params: params)
```
The example of config file is [here](https://github.com/VirgilSecurity/virgil-e3kit-x/tree/2.0.0/Tests/Data/ExampleConfig).
