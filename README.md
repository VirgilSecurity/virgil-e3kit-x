...
```
github "VirgilSecurity/virgil-e3kit-x" ~> 0.8.0-beta5
```
...
```swift 
    ...
    let ethree = try! EThree(params: params)
```
The example of config file is [here](https://github.com/VirgilSecurity/virgil-e3kit-x/tree/0.8.0-beta5/Tests/Data/ExampleConfig).
